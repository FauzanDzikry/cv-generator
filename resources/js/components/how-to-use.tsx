        ...
        <>
            ...
            >
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-6xl">
                        {/* Header Section */}
                        <div className="fade-in-up mb-16 text-center delay-100">
                            <div className="animate-float mb-6 inline-flex h-14 w-14 cursor-default items-center justify-center rounded-full bg-red-50 shadow-sm ring-8 ring-red-50/50 transition-colors duration-300 hover:bg-red-100 dark:bg-red-900/30 dark:ring-red-900/20 dark:hover:bg-red-900/50">
                            ...
                            <h2 className="mb-4 cursor-default text-4xl font-bold text-gray-900 dark:text-white">How to Use CV Generator</h2>
                            <p className="mx-auto max-w-3xl cursor-default text-lg text-gray-500 dark:text-gray-400">
                        ...
                        <div className="relative mb-20">
                            <div className="relative flex flex-col items-stretch justify-center gap-8 lg:flex-row lg:items-center">
                                {/* Step 1 */}
                                <div className="group fade-in-up relative z-10 mx-auto w-full max-w-md cursor-pointer delay-200 lg:w-1/2">
                                    <div className="h-full rounded-[2rem] border border-gray-100 bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_40px_rgb(239,68,68,0.1)] sm:p-10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none dark:hover:shadow-[0_20px_40px_rgb(239,68,68,0.05)]">
                                        <div className="mb-6 flex items-center space-x-4">
                                            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-red-50 text-xl font-bold text-red-500 shadow-sm transition-all duration-300 group-hover:scale-110 group-hover:rotate-12 group-hover:bg-red-500 group-hover:text-white dark:bg-red-900/30 dark:text-red-400 dark:group-hover:bg-red-500 dark:group-hover:text-white">
                                                1
                                            </div>
                                            <h3 className="text-2xl font-bold text-gray-900 transition-colors duration-300 group-hover:text-red-500 dark:text-white dark:group-hover:text-red-400">
                                                Fill the Form
                                            </h3>
                                        </div>
                                        <p className="mb-8 leading-relaxed text-gray-500 dark:text-gray-400">
                                            Complete all required information such as personal data, professional experience, education, and skills
                                        ...
                                        <ul className="space-y-4">
                                            {[
                                                ...
                                                <li
                                                    key={i}
                                                    className="flex items-center text-gray-600 transition-all duration-200 hover:translate-x-1 hover:text-red-600 dark:text-gray-300 dark:hover:text-red-400"
                                                >
                                ...
                                {/* Arrow Connector */}
                                <div className="fade-in-up absolute top-1/2 left-1/2 z-0 hidden -translate-x-1/2 -translate-y-1/2 items-center justify-center delay-300 lg:flex">
                                    <div className="animate-slide-right flex h-12 w-12 items-center justify-center rounded-full border border-gray-100 bg-white text-gray-400 shadow-md dark:border-gray-700 dark:bg-gray-800">
                                        <svg
                                ...
                                {/* Step 2 */}
                                <div className="group fade-in-up relative z-10 mx-auto w-full max-w-md cursor-pointer delay-300 lg:w-1/2">
                                    <div className="h-full rounded-[2rem] border border-gray-100 bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_20px_40px_rgb(34,197,94,0.1)] sm:p-10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none dark:hover:shadow-[0_20px_40px_rgb(34,197,94,0.05)]">
                                        ...
                                        <ul className="space-y-4">
                                            {[
                                                ...
                                                <li
                                                    key={i}
                                                    className="flex items-center text-gray-600 transition-all duration-200 hover:translate-x-1 hover:text-green-600 dark:text-gray-300 dark:hover:text-green-400"
                                                >
                        ...
                        <div className="fade-in-up relative mx-auto w-full max-w-5xl overflow-hidden rounded-[2.5rem] border border-red-50 bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] delay-200 md:p-12 dark:border-gray-700 dark:bg-gray-800">
                            {/* Decorative background element */}
                            <div className="pointer-events-none absolute -top-24 -right-24 z-0 h-64 w-64 rounded-full bg-red-50 opacity-50 blur-3xl dark:bg-red-900/20"></div>
                            ...
                            <div className="relative z-10 flex flex-col items-center gap-12 lg:flex-row">
                                ...
                                <div className="w-full lg:w-1/2">
                                    ...
                                    <ul className="space-y-5 font-medium text-gray-700 dark:text-gray-300">
                                        <li className="group flex cursor-pointer items-center gap-4 transition-all duration-300 hover:translate-x-2">
                                            ...
                                            <span className="transition-colors duration-300 group-hover:text-red-600 dark:group-hover:text-red-400">
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="group relative overflow-hidden rounded-[2rem] border border-slate-100 bg-slate-50 p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl sm:p-10 dark:border-gray-700 dark:bg-gray-900/50">
                            ...
                            <div className="space-y-6">
                                <div className="group flex cursor-pointer items-start space-x-4 rounded-xl bg-gray-50 p-4 transition-all duration-300 hover:-translate-y-1 hover:bg-blue-50 hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 transition-colors duration-300 group-hover:bg-blue-500 dark:bg-blue-900/30 dark:group-hover:bg-blue-500">
                                        <svg
                                            className="h-5 w-5 text-blue-600 transition-colors duration-300 group-hover:text-white dark:text-blue-400"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                    ...
                                    <div>
                                        <h4 className="mb-1 font-semibold text-gray-900 transition-colors duration-300 group-hover:text-blue-700 dark:text-white dark:group-hover:text-blue-300">
                                            Use Clear Language
                                        </h4>
                                ...
                                <div className="group flex cursor-pointer items-start space-x-4 rounded-xl bg-gray-50 p-4 transition-all duration-300 hover:-translate-y-1 hover:bg-green-50 hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-green-100 transition-colors duration-300 group-hover:bg-green-500 dark:bg-green-900/30 dark:group-hover:bg-green-500">
                                        <svg
                                            className="h-5 w-5 text-green-600 transition-colors duration-300 group-hover:text-white dark:text-green-400"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                    ...
                                    <div>
                                        <h4 className="mb-1 font-semibold text-gray-900 transition-colors duration-300 group-hover:text-green-700 dark:text-white dark:group-hover:text-green-300">
                            ...
                            <div className="space-y-6">
                                <div className="group flex cursor-pointer items-start space-x-4 rounded-xl bg-gray-50 p-4 transition-all duration-300 hover:-translate-y-1 hover:bg-purple-50 hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-purple-100 transition-colors duration-300 group-hover:bg-purple-500 dark:bg-purple-900/30 dark:group-hover:bg-purple-500">
                                        <svg
                                            className="h-5 w-5 text-purple-600 transition-colors duration-300 group-hover:text-white dark:text-purple-400"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                    ...
                                    <div>
                                        <h4 className="mb-1 font-semibold text-gray-900 transition-colors duration-300 group-hover:text-purple-700 dark:text-white dark:group-hover:text-purple-300">
                                ...
                                <div className="group flex cursor-pointer items-start space-x-4 rounded-xl bg-gray-50 p-4 transition-all duration-300 hover:-translate-y-1 hover:bg-red-50 hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-red-100 transition-colors duration-300 group-hover:bg-red-500 dark:bg-red-900/30 dark:group-hover:bg-red-500">
                                        <svg
                                            className="h-5 w-5 text-red-600 transition-colors duration-300 group-hover:text-white dark:text-red-400"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                        >
                                            <path
                                    ...
                                    <div>
                                        <h4 className="mb-1 font-semibold text-gray-900 transition-colors duration-300 group-hover:text-red-700 dark:text-white dark:group-hover:text-red-300">
                                            Check Spelling
                                        </h4>
                                        <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <section className="relative overflow-hidden bg-slate-900 py-20 md:py-28">
                <div className="absolute inset-0 z-0">
                    <div className="absolute -top-20 -left-20 h-64 w-64 animate-pulse rounded-full bg-rose-500/10 blur-3xl"></div>
                    <div className="absolute -right-20 -bottom-20 h-64 w-64 animate-pulse rounded-full bg-blue-500/10 blur-3xl delay-700"></div>
                </div>
                <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="fade-in-up mx-auto max-w-4xl text-center delay-100">
                        <h2 className="mb-6 text-4xl font-bold text-white md:text-5xl">Ready to Create a Professional CV?</h2>
                        <p className="mb-12 text-lg text-slate-400 md:text-xl">Start now and create an impressive CV in minutes.</p>
                        <a
                            href="#cvgen"
